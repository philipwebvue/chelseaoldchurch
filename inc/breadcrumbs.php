...
/**
 * breadcrumbs.php
 * Generic breadcrumb function just call this function where ever a bread crumb is required. May need a little styling or tweaking dependant upon design.
 *
...
function custom_breadcrumbs($args=[]) {
    ...
    if ( !is_front_page() ) {
        ...
        echo '<ul id="' . $args['id'] . '" class="' . $args['classes'] . '">';

        if($args['show_home']) {
            // Home page
            echo '<li class="item-home"><a class="bread-link bread-home" href="' . get_home_url() . '" title="' . $args['home_title'] . '">' . $args['home_title'] . '</a></li>';
            echo '<li class="separator separator-home"> ' . $args['separator'] . ' </li>';
        }
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if($post_type != 'post') {
                ...
                echo '<li class="separator"> ' . $args['separator'] . ' </li>';
            ...
            if(!empty($category))
            {
                echo '<li class="item-cat item-post-type-archive"><a class="bread-cat bread-custom-post-type-archive" href="' . home_url('/news/category/'.$category->slug) . '" title="' . $category->name . '">' . $category->name . '</a></li>';
                echo '<li class="separator"> ' . $args['separator'] . ' </li>';
            }
            ...
            if(!empty($category)) {
                ...
                foreach($cat_parents as $parents) {
                    ...
                    $cat_display .= '<li class="separator"> ' . $args['separator'] . ' </li>';
                }
            ...
            if( $post->post_parent ){
                ...
                foreach ( $anc as $ancestor ) {
                    ...
                    $parents .= '<li class="separator separator-' . $ancestor . '"> ' . $args['separator'] . ' </li>';
                }
            ...
            echo '<li class="separator separator-' . get_the_time('Y') . '"> ' . $args['separator'] . ' </li>';

            // Month link
            echo '<li class="item-month item-month-' . get_the_time('m') . '"><a class="bread-month bread-month-' . get_the_time('m') . '" href="' . get_month_link( get_the_time('Y'), get_the_time('m') ) . '" title="' . get_the_time('M') . '">' . get_the_time('M') . ' Archives</a></li>';
            echo '<li class="separator separator-' . get_the_time('m') . '"> ' . $args['separator'] . ' </li>';
