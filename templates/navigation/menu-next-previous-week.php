...
<div class="week-navigation flex justify-between items-end mb-11">
    <div class="font-theme uppercase tracking-[0.15em] text-mxl week-nav-prev min-w-[288px]">
    ...
    <div class="font-theme uppercase tracking-[0.15em] text-mxl week-nav-next min-w-[288px]">
